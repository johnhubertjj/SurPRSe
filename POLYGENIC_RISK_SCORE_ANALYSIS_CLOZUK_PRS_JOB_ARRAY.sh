...
plink --bfile CLOZUK_GWAS_BGE_chr${chromosome_number}_2 --extract CLUMPED_EXTRACT_CLOZUK_chr${chromosome_number}.txt --make-bed --out CLOZUK_GWAS_BGE_CLUMPED_chr${chromosome_number}
...
awk '{ $6=$7=$8=$10=$12=$13=$14=$15=$16=$17=""; print$0}' PGC_table${chromosome_number}_new.txt > PGC_table_for_python${chromosome_number}.txt
