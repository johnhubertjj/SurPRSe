...
plots <- plots + xlim(0,25) + ylim(0,25) + labs (x = expression(PRS~~-log[10](italic(p))), y = expression(MAGMA~~-log[10](italic(p)))) + ggtitle(paste0 (sig[i], "correlations = ", correlations[i]))
print(plots)                                                                                                                                
}
