...
Validation_datatable_bed_file <- gsub("NA","",Validation_datatable_bed_file)

for (i in chromosomes_to_parse){
  new_data_frame[i,1] <- paste0(Validation_datatable_bed_file,"_",i,"_",Training_name,"_CLUMPED")
}
filename <- paste0(Validation_name,"_",Training_name,"_FULL_GENOME_CLUMPED_MAKE_LIST_INPUT.txt")
