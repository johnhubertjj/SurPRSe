...
magma --annotate window=35,10 --snp-loc combined_${training_set_name}_${validation_set_name}_table_with_CHR.POS_identifiers_flipped_alleles_no_duplicates_MAF_INFO_snploc.txt --gene-loc ${path_to_stationary_data}${Gene_location_filename} --out ${training_set_name}_${validation_set_name}_annotation_MAGMA
...
magma --gene-results ${training_set_name}_${validation_set_name}_MAGMA.genes.raw --set-annot ${Pathway_filename_minus_extension} --out ${training_set_name}_${validation_set_name}_gene_set_analysis