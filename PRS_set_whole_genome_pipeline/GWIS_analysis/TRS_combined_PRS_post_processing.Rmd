...
keep_columns <- c("FID", "IID", PRS_names)

list_of_data <-  list(
  regress_results = Full_data,
  rows_to_keep_SCZ_narrow_TRS = rows_to_keep_SCZ_narrow_TRS[, keep_columns, with = F],
  rows_to_keep_SCZ_broad_TRS = as.data.frame(rows_to_keep_SCZ_broad_TRS[, keep_columns, with = F]),
  rows_to_keep_SCZ_broad_minus_narrow_TRS = as.data.frame(rows_to_keep_SCZ_broad_minus_narrow_TRS[, keep_columns, with = F]),
  COGS_treatment_resistance = as.data.frame(COGS_treatment_resistance[, keep_columns, with = F])
)
...
save(list_of_data, file = paste0(Location_of_analysis,Name_of_analysis,"_",time_of_analysis,".Rdata"))
