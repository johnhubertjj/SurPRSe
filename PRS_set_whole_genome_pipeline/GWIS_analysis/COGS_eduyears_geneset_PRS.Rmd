---
title: "COGS_EDUYEARS_pathway_DSM"
...
* Analysis on COGS re-done with EDU_Years as a training set in each polygenic risk score.
...
Name_of_analysis <- "COGS_EDU_YEARS_pathway_PRS_analysis"
significance_threshold <- c(5e-08,1e-06,1e-04,0.01,0.05,0.1,0.2,0.5,1)
Location_of_analysis <- ("~/Documents/COGS_pathways_results/EDU_years_COGS_analysis/")

# Location of whole genome files
Location_of_whole_genome_normal_gene_files <- paste0("~/Documents/COGS_pathways_results/EDU_years_COGS_analysis/PRS_scoring/EduYears_Main_COGS_normal_gene_regions_Clumped_whole_genome_final_significance_threshold_at_",significance_threshold,".profile")

Location_of_whole_genome_extended_gene_files <- paste0("~/Documents/COGS_pathways_results/EDU_years_COGS_analysis/PRS_scoring/EduYears_Main_COGS_extended_gene_regions_Clumped_whole_genome_final_significance_threshold_at_",significance_threshold,".profile")

Location_of_whole_genome_entire_genome_files <-  paste0("~/Documents/COGS_pathways_results/EDU_years_COGS_analysis/EDU_years_whole_genome/EduYears_Main_COGS_output/PRS_scoring/EduYears_Main_COGS_whole_genome_significance_threshold_at_",significance_threshold,".profile")

# Location of gene-set PRS files
Location_of_extended_gene_set_PRS_files <- "~/Documents/COGS_pathways_results/EDU_years_COGS_analysis/FINAL_PATHWAY_RESULTS_PRS_PROFILESEduYears_Main_COGS_Selected_Pocklington_plus_GO_pathways_SCHIZ_extended.txt"
Location_of_gene_boundary_gene_set_PRS_files <- "~/Documents/COGS_pathways_results/EDU_years_COGS_analysis/FINAL_PATHWAY_RESULTS_PRS_PROFILESEduYears_Main_COGS_Selected_Pocklington_plus_GO_pathways_SCHIZ_normal.txt"
