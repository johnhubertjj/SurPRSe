...
significance_thresholds <- args[1]
...
Schizophrenia <- fread("PRS_scoring_SCZ_CLOZUK_PGC2nocogs/CLOZUK_PGC2noCOGS_COGSv2016_IMPUTE2_whole_genome_significance_threshold_at_",i,".profile")
...
Bipolar <- fread("PRS_scoring_BIP/BIP_PGC2_COGSv2016_IMPUTE2_whole_genome_significance_threshold_at_",i,".profile")
