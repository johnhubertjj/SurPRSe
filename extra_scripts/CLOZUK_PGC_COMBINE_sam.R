...
Validation_datatable_bim_file <- "~/Documents/CLOZUK_PGC2noclo.METAL/ALSPAC_hrc_imputed_step3_mri_brain_measurements_only_chr",chromosome.number,"/ALSPAC_hrc_imputed_step3_mri_brain_measurements_only_chr22.bim"

# testa <- fread("~/Documents/CLOZUK_PGC2noclo.METAL/CLOZUK_PGC2noclo_more_sig_thresh_ALSPAC_output/CLOZUK_PGC2noclo_more_sig_thresh_table22_new.txt")
Training_name <- "CLOZUK_PGC2noclo"
Validation_name <- "ALSPAC_hrc_imputed_step3_mri_brain_measurements_only" 
Training_datatable <- "~/Documents/CLOZUK_PGC2noclo.METAL/CLOZUK_PGC2noclo_more_sig_thresh_ALSPAC_output/CLOZUK_PGC2noclo_more_sig_thresh_table22_new.txt"
CHR <- T
SNP <- T
BP <- T
A1 <- T
...
OR <- F
BETA <- T
number_of_frequency_columns <- NULL
...
combined.CLOZUK.PGC <- merge(x = PGC.alternative, y = CLOZUK.alternative, by = c('BP','CHR'), all = F, sort = F) # training is CLOZUK which is *.x, testing is ALSPAC
